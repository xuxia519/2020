...
import { addOutboundRecord } from '@actions/pavo';
...
class addModal extends Component {
  ...
  handleSubmit(e) {
    ...
    this.props.form.validateFields((errors, values) => {
      ...
      this.props.addOutboundRecord({...params}).then(res=>{
        if (res.status == '201') {
      ...
      >
        <div className="modalcontent">
          <Form onSubmit={this.handleSubmit} onValuesChange={this.onValuesChange}>
            <Row>
              <Col span={8}>
                <FormItem {...formItemLayout} name="type" label="出库类型">
              ...
              <Col span={8}>
                <FormItem label="出库节点" name="warehouseAreaId" {...formItemLayout}>
              ...
              <Col span={8}>
                <FormItem {...formItemLayout} name="code" label="出库单号">
...
export default connect((state) => state.warehouse, { addOutboundRecord })(addModal)